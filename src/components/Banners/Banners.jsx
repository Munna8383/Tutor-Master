...
const Banners = () => {
    return (
        <div className="">
            ...
            <div className="bg-[url('/groupTeacher.jpg')] bg-contain bg-no-repeat lg:bg-cover bg-fixed bg-center h-[80vh] md:h-screen md:rounded-b-[450px] ">

                <div className="h-[80vh] md:h-screen flex justify-center items-center bg-[rgba(0,0,0,0.6)] md:rounded-b-[450px]">

                    <div className="space-y-5 mt-5 sm:mt-0 sm:space-y-7 md:space-y-10 text-white text-center sm:w-9/12 mx-auto hidden md:block z-40">
