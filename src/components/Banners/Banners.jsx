...
const Banners = () => {
    return (
        <div>
            ...
            <div className="bg-[url('https://i.imghippo.com/files/VTv3i1726517639.jpg')] bg-cover bg-center h-screen rounded-b-[-400px] ">

                <div className="h-screen flex justify-center items-center bg-[rgba(0,0,0,0.6)] rounded-b-[-400px]">
