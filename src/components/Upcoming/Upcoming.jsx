...
<h1 className="text-3xl font-bold">Upcoming Feature</h1>
</div>


<div className="flex flex-col lg:flex-row items-center lg:items-stretch p-5 mt-5">

  <div className="w-full bg-slate-800 lg:w-1/2 flex flex-col justify-center">
  ...
  <div className="w-full lg:w-1/2 flex justify-center">
    <Image className=" w-full" height={200} width={300} alt="mobile" src="/mobile.jpeg" />
  </div>
