                ...
                <div className="w-full">
                    ...
                    <form className="mt-5">
                        ...
                        <div className="w-full p-1">
                            ...
                            <Input className="w-full my-3 " type="text" placeholder="Email" name="email" />
                        </div>
                        <div className="w-full p-1">
                    ...
                    <div>
                        <p className="text-center py-5 text-sm sm:text-lg font-bold">Already Have Account ? <Link className="text-orange-500" href={"/login"}>Login</Link></p>
                    </div>
                </div>
